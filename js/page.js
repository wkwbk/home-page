parcelRequire = function (e, r, t, n) {
    ...
    "Bb20": [function (require, module, exports) {
        ...
        function e() {
            var e = ["希望能成为有趣的人", "给时光以生命<br>给岁月以文明", "你好，请多指教", "当你在凝视着网页的时候<br>网页也正在凝视着你", "平凡的日常正奇迹的发生着", "Lata<br>lulila<br>lulula<br>lulalila ♪♫", "欢迎大家光临星象馆<br>这里有着无论何时永远不会消失<br>美丽的无穷光辉<br>满天的星星等候着大家的到来", "*舒缓的现代音乐*"],
                i = o(0, e.length - 1);
            t("#slogan").html(e[i])
        }
