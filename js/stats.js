...
(function (h, n) {
    ...
    function B(c) {
        var a = window.location,
            ...
            d = a.pathname,
            e = function () {
                t(("https:" == document.location.protocol ? "https://" : "http://") + "taj.qq.com/ping_hotclick_min.js", function () {
    ...
    function C(c) {
        var a = {
            9: "\u817e\u8baf\u5206\u6790",
            10: "\u7f51\u7ad9\u7edf\u8ba1",
            df: '<img src="' + (("https:" == document.location.protocol ? "https:" : "http:") + "//taj.qq.com/icon/toss_" + c + ".gif") + '" border="0" />'
        };
